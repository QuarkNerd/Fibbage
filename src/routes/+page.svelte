...
<div class="main">
	Welcome to Fibbage with custom questions. In this game you try to trick your friends while finding
	...
	<h3>How to play?</h3>
	<div class="box">
		In each round you are presented with a question.
		<br />
		<br />
		...
		<br />
		<br />
		You will earn points for getting the question right and for everyone who chooses your answer.
	</div>
</div>
