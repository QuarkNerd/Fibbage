...
<div class="main">
	<h3>Instrucutions</h3>
	<div class="box">
		To create a game you need to supply a list of possible questions. Use the file selector or
		textbox below.
		<br /><br />
		The format is to have the questions and answers seperated by a new line, with each set seperated
		by a line containing only '-'s. There is an example below.
		<br /><br />
		Add at least 5 questions.
		<br /><br />
		Click submt questions and the game will choose 5 questions from the list at random and download a
		file of the remaining questions for future games.
		<br /><br />
